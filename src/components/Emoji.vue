...
<template>
  <GridLayout class="bg-white rounded-t-3xl  p-2 pt-8 " :height="Screen.mainScreen.heightDIPs">
    <StackLayout>
    ...
    <TextField v-model="q" verticalAlignment="top" hint="🔎 Search" class="bg-gray-200 text-black rounded-xl text-xl  p-4 mt-2 " width="100%" color="black" :editable="true">
    </TextField>
  </GridLayout>
</template>
